      ...
      <section className='container px-5 py-24 mx-auto'>
        ...
        <div className='flex flex-wrap -m-4'>
          <Link
            ...
            className='xl:w-1/4 md:w-1/2 bg-foreground/10 p-6 rounded-lg hover:bg-foreground/20 transition-colors'
          >
            <Image
            ...
            <p className='leading-relaxed text-base'>
              Design and implementation of a web application supporting a
              catering company.
            </p>
          </Link>
        </div>
